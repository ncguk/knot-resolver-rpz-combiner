...
# Version: 1.0.7 Knot-resolver (for Ubuntu)
...
readonly RESOLVER_USER="knot-resolver"
readonly RESOLVER_GROUP="knot-resolver"
...
readonly LIST_TMPFILE_01="$RESOLVER_CONF_DIR/blocklist_hagezi-multi-ultimate.tmp"
readonly LIST_TMPFILE_02="$RESOLVER_CONF_DIR/blocklist_oisd-big.tmp"
readonly LIST_TMPFILE_03="$RESOLVER_CONF_DIR/blocklist_1hosts-pro.tmp"
readonly LIST_TMPFILE_04="$RESOLVER_CONF_DIR/blocklist_urlhaus.tmp"

readonly LIST_TMPFILE_ALL="$RESOLVER_CONF_DIR/blocklist_*.tmp"

readonly USER_ALLOWLIST="$RESOLVER_CONF_DIR/user_allowlist.txt"
readonly USER_BLOCKLIST="$RESOLVER_CONF_DIR/user_blocklist.txt"

readonly LIST_COMBINED_TMP="$RESOLVER_CONF_DIR/blocklist_combined.staging"
...
# Make sure everything is owned by RESOLVER_USER and RESOLVER_GROUP
#(>&2 printf "Changing user and group of Knot Resolver configuration directory...\n")
#"$CHOWN" -R ${RESOLVER_USER}:${RESOLVER_GROUP} ${RESOLVER_CONF_DIR} || { (>&2 printf "Something went wrong while changing ownership of the %s directory, exiting\n" "${RESOLVER_CONF_DIR}") ; exit 1; }